...
GO_annotations <- read.table("GOs_all_PoO_genes_as_background.txt", header = T)
...
#my_genes <- read.csv("./gene_lists/maternal_both.txt",header=F)
#my_genes <- read.csv("./gene_lists/maternal_just_repro.txt",header=F)
#my_genes <- read.csv("./gene_lists/maternal_just_sterile.txt",header=F)
#my_genes <- read.csv("./gene_lists/paternal_both.txt",header=F)
#my_genes <- read.csv("./gene_lists/paternal_just_repro.txt",header=F)
my_genes <- read.csv("./gene_lists/paternal_just_sterile.txt",header=F)
...
# 59/ 79 maternal both
# 11/14 maternal repro
# 9/10 maternal sterile
# 51/70 paternal both
# 4/7 paternal repro
# 4/4 paternal sterile
...
#write.table(REVIGO,"enriched_GOs_maternal_both_genes.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"enriched_GOs_maternal_repro_genes.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"enriched_GOs_maternal_sterile_genes.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"enriched_GOs_paternal_both_genes.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"enriched_GOs_paternal_repro_genes.txt",row.names = F,sep = "\t",quote = F)
write.table(REVIGO,"enriched_GOs_paternal_sterile_genes.txt",row.names = F,sep = "\t",quote = F)
