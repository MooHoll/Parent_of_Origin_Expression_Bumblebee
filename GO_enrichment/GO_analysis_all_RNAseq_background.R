...
GO_annotations <- read.table("GOs_all_expression_genes_as_background.txt", header = T)
...
#my_genes <- read.csv("./gene_lists/PoO_genes_all.csv",header=F)
#my_genes <- read.csv("./gene_lists/LOC_abd_diff_exp_genes.txt",header=F)
my_genes <- read.csv("./gene_lists/LOC_head_diff_exp_genes.txt",header=F)
...
#161/184 (for PoO)
#6924/8097 (for abd diff exp )
#232/279  (for head diff exp)
...
#write.table(REVIGO,"enriched_GOs_allPoO_genes.txt",row.names = F,sep = "\t",quote = F)
#write.table(REVIGO,"enriched_GOs_abd_diff_exp.txt",row.names = F,sep = "\t",quote = F)
write.table(REVIGO,"enriched_GOs_head_diff_exp",row.names = F,sep = "\t",quote = F)
